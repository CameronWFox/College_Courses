...
void printTable(float monthlyPayment, float loanAmount, float annualInterestRate, int loanPerYear)
{
    ...
    float oldBalance = loanAmount;
    float principalPayment = loanAmount - annualInterestRate;
    float interestPaid = computeMonthlyIntrest(loanAmount, annualInterestRate);
    float newBalance = oldBalance - principalPayment;
    ...
    {
        month++;
        printf("%10d %10.2f %10.2f %10.2f %10.2f %10.2f\n", month, oldBalance, monthlyPayment, interestPaid = computeMonthlyIntrest(loanAmount, annualInterestRate), principalPayment = monthlyPayment - computeMonthlyIntrest(loanAmount, annualInterestRate), newBalance = oldBalance - principalPayment);
