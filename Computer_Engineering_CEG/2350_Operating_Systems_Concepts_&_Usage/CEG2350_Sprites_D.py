...
##
## Networking code is adapted from
...
class NetworkAction(Action):
    ...
    def step(self, dt):
        try:
            ...
            pass
            #print "except", len(self.message_queue)

#
global_message_queue = collections.deque()
...
class ChessBoard(Layer):
    ...
    def __init__(self):
        ...
        self.do(NetworkAction(global_message_queue))
...
class EchoRequestHandler(SocketServer.BaseRequestHandler):
    ...
    def handle(self):
        while 1:
            ...
            global_message_queue.append(data)
            print len(global_message_queue)
...
if __name__ == "__main__":
    ...
    server = SocketServer.ThreadingTCPServer(('localhost', 8081), EchoRequestHandler)
